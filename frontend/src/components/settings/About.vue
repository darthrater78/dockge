<template>
    <div class="d-flex justify-content-center align-items-center">
        <div class="logo d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="my-3 update-link"><a href="https://github.com/darthrater78/dockge/releases/tag/v2.0.0-beta.10" target="_blank" rel="noopener">{{ $t("Check Update On GitHub") }}</a></div>
