<template>
    <transition name="slide-fade" appear>
        <div>
            ...
            <TerminalPanel storage-key="dockge-terminal-height" :rows="20" mode="interactive" :name="terminalName" :stack-name="stackName" :service-name="serviceName" :shell="shell" :endpoint="endpoint" />
        </div>
    </transition>
</template>
